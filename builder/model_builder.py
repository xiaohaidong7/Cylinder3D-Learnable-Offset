...
# Modified in 2026 to configure the learnable cylindrical offset module.
...
def build(model_config):
    ...
    cy_fea_net = cylinder_fea(grid_size=output_shape,
                              ...
                              learnable_offset=model_config.get('learnable_offset', False),
                              offset_scale=model_config.get('offset_scale'),
                              offset_hidden_dim=model_config.get('offset_hidden_dim', 32))
