# -*- coding:utf-8 -*-
# author: Xinge
# Modified in 2026 to support learnable cylindrical offset configuration.
...
model_params = Map(
    {
        ...
        "use_norm": Bool(),
        "init_size": Int(),
        Optional("learnable_offset"): Bool(),
        Optional("offset_hidden_dim"): Int(),
        Optional("offset_scale"): Seq(Float()),
    }
)
